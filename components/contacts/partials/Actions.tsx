...
import { ContainerColumn, ContainerGrid } from '../../Global/styledGlobal';
const Actions = () => {
    return (
        <ContainerColumn>
            <Box>
                <Typography color={"primary"} fontWeight={900} component={"h1"} variant='h5' > Nossos Contactos</Typography>
